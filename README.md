...
3. Download and install the [Microsoft Planner JDBC Driver from CData](https://www.cdata.com/drivers/msplanner/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
